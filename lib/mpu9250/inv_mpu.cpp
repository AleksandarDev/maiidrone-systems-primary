...
#if !defined AK8963_SECONDARY /* #if defined AK8975_SECONDARY */
#define AK8963_SECONDARY
...
int mpu_init(struct int_param_s *int_param)
{
    ...
    Serial.println("Do we have compass?");
#ifdef AK89xx_SECONDARY
//#ifdef MPU_DEBUG
    Serial.println("Setting up compass AK89XX");
//#endif
...
//#endif
    ...
    if (mpu_set_compass_sample_rate(10))
        return -15;
#else
    Serial.println("No compass. Bypassing.");
